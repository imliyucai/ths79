/**
  ...
  * @brief     RSD79 board bsp
	*            driver header file of rf_chip cmt2300a 
  ******************************************************************************
  **/ 
...
//uint8_t CMT2300A_IO_Init(void);

//extern void CMT2300A_SendByte( uint8_t data8 );
//extern uint8_t CMT2300A_RecvByte( void );




extern bool8_t CMT2300A_IsExist( void );
extern uint8_t CMT2300A_GetChipStatus( void );


extern void CMT2300A_ConfigGpio( uint8_t nGpioSel );
extern void CMT2300A_ConfigInterrupt( uint8_t nInt1Sel, uint8_t nInt2Sel );
extern void CMT2300A_EnableInterrupt( uint8_t nEnable );
extern uint8_t CMT2300A_ClearInterruptFlags( void );
extern bool8_t CMT2300A_ConfigRegBank( uint8_t base_addr, const uint8_t bank[], uint8_t len );
extern void CMT2300A_EnableLfosc( bool8_t bEnable );
extern void CMT2300A_SetPayloadLength( uint16_t nLength );
extern void CMT2300A_SetFrequencyStep( uint8_t nOffset );
extern void CMT2300A_SetFrequencyChannel( uint8_t nChann );

extern void CMT2300A_RestoreFifo( void );
extern void CMT2300A_EnableFifoMerge(bool8_t bEnable);
...
extern enumRFResult  RF433M_Processing( void );

extern void RF433M_StartTx( uint8_t buf[], uint16_t len, uint32_t timeout );
extern void RF433M_StartRx( uint8_t buf[], uint16_t len, uint32_t timeout );




#endif   // __DRV_CMT2300A_H
